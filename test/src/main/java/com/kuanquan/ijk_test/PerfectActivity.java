...
import com.kuanquan.ijk_test.tools.FileUtil;
...
public class PerfectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mContext = this;
        rootView = LayoutInflater.from(this).inflate(R.layout.activity_perfect, null);
        ...
        String url1 = FileUtil.getLocalVideoPath("my_video.mp4");
