...
public interface PlayStateParams {
    ...
    /**上下样式*/
    int PROCESS_PORTRAIT = 0;
    /**左右样式*/
    int PROCESS_LANDSCAPE = 1;
    /**中间两边样式*/
    int PROCESS_CENTER = 2;
     ...
     * 准备中/加载中
     */
    int STATE_PREPARING = 332;
    /**
     * 准备完成
     */
    int STATE_PREPARED = 333;
    /**
     * 播放中
     */
    int STATE_PLAYING = 334;
    /**
     * 暂停
     */
    int STATE_PAUSED = 335;
    /**
     * 播放完成
     */
    int STATE_COMPLETED = 336;
    /**====================播放器中使用的播放状态 结束=================================*/
